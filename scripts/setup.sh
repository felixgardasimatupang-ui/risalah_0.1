...
echo ""
echo "Cara pakai:"
echo "  python risalah/pipeline.py rekaman.mp4                        # DOCX standar (paralel otomatis)"
...
echo "  python risalah/pipeline.py rekaman.mp4 --no-parallel          # Nonaktifkan paralel"
...
echo "  python risalah/pipeline.py rekaman.mp4 --skip transcribe      # Skip transkripsi (pakai cache)"
